// Taxonomy reference: Lee et al. (2025), arXiv:2504.20799
// Four categories: syntactic | runtime | functional | quality
const TAXONOMY = {
  syntactic: { label: "Syntactic Hallucination", desc: "Violates language syntax; won't compile or interpret." },
  runtime: { label: "Runtime Execution Hallucination", desc: "Syntactically valid but fails at runtime." },
  functional: { label: "Functional Correctness Hallucination", desc: "Executes, but doesn't meet the requirement." },
  quality: { label: "Code Quality Hallucination", desc: "Introduces resource, security, or maintainability risk." }
};
...
const HALLUCINATION_PATTERNS = [
  ...
  // 1. FABRICATED PACKAGES
  {
    ...
    category: "runtime",
    subCategory: "API knowledge conflict",
    severity: "high",
    language: "python",
  ...
  // 2. NON-EXISTENT METHODS
  {
    ...
    paper: "De-Hallucinator · Eghbali & Pradel 2024"
  },
